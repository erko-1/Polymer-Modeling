...
def update(frame):
    ...
    # Plot monomers
    ax.scatter(polymer[:8, 0], polymer[:8, 1], polymer[:8, 2], color='r')
    ax.scatter(polymer[11:, 0], polymer[11:, 1], polymer[11:, 2], color='r')
    ax.scatter(polymer[9,0],polymer[9,1], polymer[9,2], color='b')
    ax.scatter(polymer[10,0],polymer[10,1], polymer[10,2], color='b')
