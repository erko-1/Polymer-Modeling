...
def update(frame):
    ...
    # Gyration tensor calculation and averaging every 500 steps
    if frame != 0 and frame % 500 == 0:
        ...
        Rg2_1 = np.sum(eigvals1)
        Rg2_2 = np.sum(eigvals2)

        Rg_squared_ring1.append(Rg2_1)
        Rg_squared_ring2.append(Rg2_2)    
