...
num_monomers = 5000  # Number of monomers in the polymer
...
polymer = np.cumsum(np.random.randn(num_monomers, 3) * 0.1, axis=0)
...
for step in range(num_steps):
    ...
    displacement = (np.random.rand(3) - 0.5) * step_size  # Random move
